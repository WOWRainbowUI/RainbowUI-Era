...
L.DisplayTooltipCurrencyData = "兌換通貨要顯示"
L.DisplayLineSeparator = "顯示空行分隔線"
L.DisplayCurrentPlayer = "當前玩家"
L.DisplayCurrentPlayerOnly = "|cFFFFD700只顯示|r當前玩家! |cFFDF2B2B(不推薦)|r"
L.DisplayCurrentRealmName = "顯示 |cFF4CBB17[當前伺服器]|r 的玩家"
L.DisplayCurrentRealmShortName = "|cFF4CBB17[當前伺服器]|r 使用縮寫名稱"
...
L.ColorCurrentRealm = "BagSync [當前伺服器] 提示顏色"
