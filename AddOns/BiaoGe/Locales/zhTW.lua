...
do --繁体更新内容
    ...
    update = update .. [[-裝備庫的聖物分類現在合併到遠程分類裡]] .. "\n"
    update = update .. [[-<賽季服>裝備庫添加聲望裝備和PVP裝備]] .. "\n"
    update = update .. [[-<賽季服>更新黑暗深淵掉落]] .. "\n"
    update = update .. [[-<賽季服>裝備過濾方案現在可以過濾特定詞綴了]] .. "\n"
    update = update .. [[-<賽季服>角色團本總覽現在可以生效了]] .. "\n\n"

    update = update .. "|cff00FF00" .. "12月7日更新1.7.1b版本" .. "|r\n"
    update = update .. [[-再次修復自動清空表格的問題（這次應該沒問題了）]] .. "\n"
    update = update .. [[-修復了撤回清空時可能會丟失數據的問題]] .. "\n"
    update = update .. [[-<賽季服>修復了在黑暗深淵不會自動記錄裝備的問題]] .. "\n"
    update = update .. [[-<賽季服>修復了在黑暗深淵不會自動清空表格的問題]] .. "\n\n"

    update = update .. "|cff00FF00" .. "12月6日更新1.7.1版本" .. "|r\n"
    update = update .. [[-插件現在支持Plus賽季服]] .. "\n"
    update = update .. [[-修復一些小問題]] .. "\n\n"

    update = update .. "|cff00FF00" .. "12月2日更新1.7.0版本" .. "|r\n"
    update = update .. [[-全新的拍賣系統]] .. "\n"
    update = update .. [[-由於熱鍵衝突，之前的拍賣倒數功能已刪除]] .. "\n"
    update = update .. [[-修復了退出BiaoGeYY頻道後，下次登錄時又會自動加入的問題]] .. "\n"
    update = update .. [[-再次修復在有副本進度的情況下，錯誤地自動清空表格的問題]] .. "\n\n"

    update = update .. "|cff00FF00" .. "11月28日更新1.6.8d版本" .. "|r\n"
    update = update .. [[-一鍵分配功能現在支持ElvUI了]] .. "\n\n"

    update = update .. "|cff00FF00" .. "11月27日更新1.6.8c版本" .. "|r\n"
    update = update .. "-修復了在有副本進度時，偶爾會錯誤地自動清空表格的問題\n"
    update = update .. "-修復了一鍵分配的一個小問題\n\n"

    update = update .. "|cff00FF00" .. "11月26日更新1.6.8b版本" .. "|r\n"
    update = update .. "-在戰利品拾取介面增加一鍵分配功能\n"
    update = update .. "-指定靈魂烘爐改為指定伽馬靈魂烘爐\n"
    update = update .. "-修復了在交易裝備時會將該裝備記錄到表格中的問題\n\n"
