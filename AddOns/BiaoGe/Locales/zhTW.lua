...
do --繁体说明书
    ...
    update = update .. [[-<賽季服>角色總覽：增加<煉金轉化CD>]] .. "\n"
    update = update .. [[-<賽季服>現在CTRL+點擊裝備兌換物（例如：竭能胸甲）也可以跳轉至裝備庫了]] .. "\n"
    update = update .. [[-<賽季服>刪除通報賬單裡的"金團"關鍵字]] .. "\n\n"
    ...
    update = update .. [[-修復了可堆疊物品在記錄進表格時，可能出現數量記錄不正確的問題]] .. "\n"
    update = update .. [[-<赛季服>新增功能：血月活动期間，自動施放屍體和對話自動復活（該功能默認關閉）]] .. "\n"
    update = update .. [[-<赛季服>添加幾件之前漏掉的P2團本掉落裝備]] .. "\n"
    update = update .. [[-<赛季服>裝備庫：添加P2的PVP軍階獎勵裝備]] .. "\n\n"
...
do --繁体更新内容
    ...
    update = update .. [[-<賽季服>P2裝備庫：添加更多由專業製造的綠裝]] .. "\n"
    update = update .. [[-<賽季服>P2表格：尾王格子增加至10個]] .. "\n"
    update = update .. [[-<賽季服>修復了進本不會自動清空P2表格的問題]] .. "\n"
    update = update .. [[-<60服>40人團本不再記錄世界掉落的藍色品質裝備]] .. "\n"
    update = update .. [[-修復了裝備過濾方案在更改順序後，在下次載入時名稱和圖標錯誤的問題]] .. "\n\n"

    update = update .. "|cff00FF00" .. "2月15日更新1.8.0c版本" .. "|r\n"
    update = update .. [[-集結號密語模板：活動的右鍵菜單裡增加邀請按鈕]] .. "\n"
    update = update .. [[-<賽季服>更新P2團本掉落列表]] .. "\n"
    update = update .. [[-<賽季服>P2表格裡3號Boss跟4號位置調換]] .. "\n"
    update = update .. [[-<賽季服>P2表格裡尾王格子增加至8個（因為5號的裝備可能會被記到尾王導致格子不夠）]] .. "\n\n"

    update = update .. "|cff00FF00" .. "2月13日更新1.8.0b版本" .. "|r\n"
    update = update .. [[-裝備庫：現在CTRL+點擊裝備可以打開試衣間]] .. "\n"
    update = update .. [[-<賽季服>更新P2遭劫貨物聲望獎勵提示]] .. "\n"
    update = update .. [[-<賽季服>裝備庫添加P2專業製造新紫裝和團本任務獎勵]] .. "\n\n"
