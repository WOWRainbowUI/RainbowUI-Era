...
do
    ...
    do
        ...
        do
            ...
            -- 团本任务奖励
            BG.Loot[FB].N.Quest = {
                [BG.STC_y1(QUESTS_LABEL)] = { 216675, 216676, 216678 }
            }
            if BG.IsAlliance() then
                BG.Loot[FB].N.Quest[BG.STC_y1(FACTION_ALLIANCE .. QUESTS_LABEL)] =
    ...
    do
        ...
        do
            ...
            BG.Loot[FB].Team[FB_5] = {
                [L["安图苏尔"]] = { 9640, 9641, 9639, 9379, 9372, },
                [L["巫医祖穆拉恩"]] = { 18083, 18082, },
                [L["暗影祭司塞瑟斯"]] = { 9470, 9473, 9474, 9475, },
                [L["灰尘怨灵"]] = { 12471, },
                [L["加兹瑞拉"]] = { 9469, 9467, },
                [L["乌克兹·沙顶"]] = { 9479, 9476, 9478, 9477, 11086, 9372, },
                [L["泽雷利斯"]] = { 12470, },
        ...
        do
            ...
            BG.Loot[FB].Team[FB_5] = {
                ...
                [L["锐刺鞭笞者"]] = { 17749, 17748, 17750, 17751, },
                [L["维利塔恩"]] = { 17755, 17754, 17752, },
                [L["收割者麦什洛克"]] = { 17767, 17741, 17742, },
                [L["被诅咒的塞雷布拉斯"]] = { 17740, 17739, 17738, },
                [L["兰斯利德"]] = { 17734, 17736, 17737, 17943, },
                [L["工匠吉兹洛克"]] = { 17718, 17717, 17719, },
                [L["洛特格里普"]] = { 17732, 17728, 17730, },
                [L["瑟莱德丝公主"]] = { 17780, 17715, 17707, 17714, 17711, 17713, 17710, 17766, },
                [L["小怪"]] = {},
        ...
        do
            ...
            BG.Loot[FB].Team[FB_5] = {
                ...
                [L["审讯官格斯塔恩"]] = { 11626, 11624, 22240, 11625, },
                [L["驯犬者格雷尔玛尔"]] = { 11623, 11627, 11628, 11629, },
                [L["竞技场-修行者高罗什"]] = {},
                [L["竞技场-格里兹尔"]] = { 11722, 11703, 22270, 11702, },
                [L["竞技场-剜眼者"]] = { 11685, 11679, 11686, },
                [L["竞技场-破坏者奥科索尔"]] = { 11665, 11662, 11824, },
                [L["竞技场-阿努希尔"]] = { 11678, 11677, 11675, },
                [L["竞技场-爬行者赫杜姆"]] = { 11633, 11634, 11635, },
                [L["控火师罗格雷恩"]] = { 11747, 11749, 11748, 11750, },
                -- [L["黑色宝库"]] = {},
                [L["典狱官斯迪尔基斯"]] = { 11784, },
                -- [L["维雷克"]] = {},
                -- [L["卫兵杜格瑞普"]] = {},
...
do
    ...
    do
        ...
        if BG.IsAlliance() then
            BG.Loot[FB].Pvp = {
                ["Alliance:2"] = { 18854, 18856, 18857, 18858, 18862, 18863, 18864, 18859 }, -- 徽记
                ["Alliance:3"] = { 213087, 18440, 18441, },                                  -- 中士的披风
                ["Alliance:4"] = { 18442, 18444, },                                          -- 军士长的徽记
                ["Alliance:5"] = { 216938, 216701, 216702, 216698, 216699, 216700, },        -- 新徽记、士官长护腕
            }
        end
        if BG.IsHorde() then
...
do
    ...
    local FB = "Temple"
    BG.Loot[FB].Profession = {
        ["锻造"] = { 8708, 10418, 7947, 12774, 12773, 7946, 7954, 7945, 11608, 7961, 7944, 7960, 7959, 7931, 7932, 12624, 12415, 7929, 12416, 7937, 7934, 12428, 7928, 12405, 7939, 7935, 7930, 7936, 7933, 7938, 7927, 7926, 12424, 12406, 12425, 12408, },
        ["制皮"] = { 15045, 15046, 8367, 8347, 8215, 8216, 15064, 8349, 8211, 15073, 15071, 8213, 8197, 15091, 15074, 15083, 8346, 8348, 8345, 8214, 15057, 15054, 8212, 8202, 8193, 15061, 15067, 8210, 15092, 15084, },
        ["裁缝"] = { 14141, 14100, 14042, 13857, 13858, 13868, 13869, 14103, 14134, 13860, 10041, 10025, 10033, 10030, 10024, 10029, 10028, 10027, 10044, 10031, 10026, 13863, 14101, 14142, 14043, 13870, 14107, 14132, 14143, 13856, },
        ["工程"] = { 10721, 7189, 10724, 15999, 10504, 10588, 10726, 10503, 10506, 10545, 10542, 10543, 18637, 18634, 10576, 10727, 10645, 10725, 10587, 10720, 10716, 16004, 15995, },
    }
end
