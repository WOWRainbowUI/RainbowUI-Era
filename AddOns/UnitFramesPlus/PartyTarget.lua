...
for id = 1, 4, 1 do
    ...
    -- ToPFrame.Name:SetFont(STANDARD_TEXT_FONT, 14, "OUTLINE");
    ...
    ToPFrame.HPPct:SetFont(STANDARD_TEXT_FONT, 12, "OUTLINE");
...
function UnitFramesPlus_PartyTarget_ModeSet()
    if UnitFramesPlusDB["partytarget"]["lite"] == 1 then
        for id = 1, 4, 1 do
            ...
            _G["UFP_PartyTarget"..id].Name:SetFont(STANDARD_TEXT_FONT, 11, "OUTLINE");
        ...
        for id = 1, 4, 1 do
            ...
            _G["UFP_PartyTarget"..id].Name:SetFont(STANDARD_TEXT_FONT, 14, "OUTLINE");
            for j = 1, UFP_MAX_PARTYTARGET_DEBUFFS, 1 do
