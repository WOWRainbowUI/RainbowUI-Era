...
TargetFrameTextureFrameHealthBarText:SetFont("Font\\bHEI00M.ttf", 12, "OUTLINE");
...
TargetFrameTextureFrameManaBarText:SetFont("Font\\bHEI00M.ttf", 12, "OUTLINE");
...
function UnitFramesPlus_TargetExtraTextFontSize()
    UFP_TargetThreatText:SetFont(STANDARD_TEXT_FONT, UnitFramesPlusDB["target"]["fontsize"], "OUTLINE");
    UFP_TargetHPText:SetFont(TextStatusBarText:GetFont(), UnitFramesPlusDB["target"]["fontsize"], "OUTLINE");
    UFP_TargetMPText:SetFont(TextStatusBarText:GetFont(), UnitFramesPlusDB["target"]["fontsize"], "OUTLINE")
    UFP_TargetHPMPPctHP:SetFont(STANDARD_TEXT_FONT, UnitFramesPlusDB["target"]["fontsize"], "OUTLINE");
    UFP_TargetHPMPPctMP:SetFont(STANDARD_TEXT_FONT, UnitFramesPlusDB["target"]["fontsize"], "OUTLINE");
    UFP_TargetHPMPPctPct:SetFont(STANDARD_TEXT_FONT, UnitFramesPlusDB["target"]["fontsize"], "OUTLINE");
    UFP_TargetRace:SetFont(STANDARD_TEXT_FONT, UnitFramesPlusDB["target"]["fontsize"], "OUTLINE");
