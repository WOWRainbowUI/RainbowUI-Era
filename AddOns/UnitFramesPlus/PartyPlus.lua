...
for id = 1, MAX_PARTY_MEMBERS, 1 do
    ...
    PartyHPMPText.HealthBarText:SetFont(STANDARD_TEXT_FONT, 10, "OUTLINE");
    ...
    PartyHPMPText.ManaBarText:SetFont(STANDARD_TEXT_FONT, 10, "OUTLINE");
...
for id = 1, MAX_PARTY_MEMBERS, 1 do
    ...
    PartyLevel.Text:SetFont(STANDARD_TEXT_FONT, 10, "OUTLINE");
                ...
                _G["UFP_PartyPortraitType"..id]:SetScript("OnEvent", function(self, event, ...)
                    ...
                    elseif event == "UNIT_HEALTH_FREQUENT" then
						...
						if (not UnitIsConnected("party"..id)) or UnitIsGhost("party"..id) then
							...
							_G["UFP_Party3DPortrait"..id]:SetLight(true, lightValues);
...
for id = 1, MAX_PARTY_MEMBERS, 1 do
    ...
    PartyHPPct.Text:SetFont(STANDARD_TEXT_FONT, 10, "OUTLINE");
    ...
    -- PartyDeath.Text:SetFont(STANDARD_TEXT_FONT, 12, "OUTLINE");
...
for id = 1, MAX_PARTY_MEMBERS, 1 do
    for j = 1, UFP_MAX_PARTY_BUFFS, 1 do
        ...
        buff.CooldownText:SetFont(STANDARD_TEXT_FONT, 10, "OUTLINE");
    ...
    for j = 1, UFP_MAX_PARTY_DEBUFFS, 1 do
        ...
        debuff.CooldownText:SetFont(STANDARD_TEXT_FONT, 10, "OUTLINE");
        ...
        debuff.CountText:SetFont(STANDARD_TEXT_FONT, 10, "OUTLINE");
    ...
    --     petdebuff.CooldownText:SetFont(STANDARD_TEXT_FONT, 10, "OUTLINE");
    ...
    --     petdebuff.CountText:SetFont(STANDARD_TEXT_FONT, 10, "OUTLINE");
...
function UnitFramesPlus_PartyExtraTextFontSize()
    for id = 1, MAX_PARTY_MEMBERS, 1 do
        _G["PartyMemberFrame"..id.."HealthBarText"]:SetFont(STANDARD_TEXT_FONT, UnitFramesPlusDB["party"]["fontsize"], "OUTLINE");
        _G["PartyMemberFrame"..id.."ManaBarText"]:SetFont(STANDARD_TEXT_FONT, UnitFramesPlusDB["party"]["fontsize"], "OUTLINE");
        _G["PartyMemberFrame"..id.."Level"]:SetFont(STANDARD_TEXT_FONT, UnitFramesPlusDB["party"]["fontsize"], "OUTLINE");
        _G["PartyMemberFrame"..id.."HPPct"]:SetFont(STANDARD_TEXT_FONT, UnitFramesPlusDB["party"]["fontsize"], "OUTLINE");
        -- _G["PartyMemberFrame"..id.."DeathText"]:SetFont(STANDARD_TEXT_FONT, UnitFramesPlusDB["party"]["fontsize"]+2, "OUTLINE");
