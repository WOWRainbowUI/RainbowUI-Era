...
L["soundsBlackfathomBoonDesc"] = "¿Reproduce un sonido cuando se obtiene el beneficio de Favor de Brazanegra?";
...
L["blackfathomBoomBuffDropped"] = "El beneficio de Favor de Brazanegra ha caído.";
