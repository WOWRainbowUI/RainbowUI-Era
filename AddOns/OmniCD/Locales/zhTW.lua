...
L["Convert to additional CD bars that attach to each unit's raid frame."] = "轉成額外的冷卻條，貼齊每個單位的團隊框架。"
L["Convert to Name Bar"] = "轉換為名字列"
L["Cooldown"] = "冷卻"
L["Cooldown Remaining"] = "冷卻時間剩餘"
L["Cooldown Timer"] = "冷卻時間"
L["Copy"] = "複製"
L["Copy Default"] = "複製預設"
...
L["Use ElvUI Timer"] = "使用 ElvUI 冷卻時間"
